...
function getShowsByTerm(term) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    url = BASE_URL + "/search/shows?q=" + term;
                    return [4 /*yield*/, axios_1.default.get(url)];
                case 1:
                    res = _a.sent();
                    return [2 /*return*/, res.data.map(function (r) {
                            return ({
                                id: r.show.id,
                                name: r.show.name,
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    resp = _a.sent();
                    return [2 /*return*/, resp.data.map(function (r) { return ({
                            id: r.id,
                            name: r.name,
                            season: r.season,
                            number: r.number,
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    evt.preventDefault();
                    showId = $(evt.target).closest("div[data-show-id]").attr("data-show-id");
